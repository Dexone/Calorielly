  ...
  actions: {
    ...
    async enter(log, pass) {
      axios.get(`https://dexone.pw/backend_new/users`).then((res) => {
        ...
        if (search > 0 && res.data[search].password == pass) {
    ...
    async getInfo() {
      axios
        .get(`https://dexone.pw/backend_new/users/${this.id}`)
        .then((res) => {
    ...
    addCcal(ccalValue, ccalName) {
      if (this.id !== 1) {
        axios
          .get(`https://dexone.pw/backend_new/data/${this.id}`)
          .then((res) => {
            ...
            axios
              .patch(`https://dexone.pw/backend_new/data/${this.id}`, {
