<template>
  ...
  <svg
    ...
    fill="none"
    viewBox="0 0 24 24"
    @click="hiddenStore.showSettings()"
  >
    <path
      stroke="currentColor"
  ...
  <div class="mainBlockTarget">
    <div v-if="loginStore.eatingList[0].length > 1" class="blockTarget">
      <svg
        class="image1"
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="headerRow">
        ...
        <span class="text2"
          >осталось
          {{ loginStore.limitCcal - loginStore.getSumCcalToday }} ккал</span
        >
      </div>
